...
// R148-I9 FIX: Use shared crypto crate instead of duplicate SHA-256 implementation.
// The previous inline `mod sha256` has been replaced by the canonical implementation
// in the `crypto` crate, ensuring both livepatch and audit use the same KAT-validated
// code path.
mod sha256 {
